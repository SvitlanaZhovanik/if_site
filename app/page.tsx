...
const Page: NextPage = () => {
  return (
    <section className="relative flex h-full flex-col text-white md:overflow-hidden portrait:overflow-hidden portrait:sm:min-h-[calc(100vh-76px)] portrait:notXL:min-h-[calc(100vh-88px)] landscape:md:min-h-[calc(100vh-88px)] landscape:mdOnly:pb-[400px]">
      ...
      <Image
        className="bottom-[calc(50%-220px)] left-0 right-0 sm:left-[calc(50%-240px)] sm:max-w-[480px] md:absolute md:-bottom-[60px] md:left-[calc(50%-352px)] md:max-w-[704px] xl:-bottom-[80px] xl:left-[calc(50%-428px)] xl:max-w-[856px] portrait:notXL:absolute landscape:smOnly:mx-auto"
        src={gif}
        alt={home.image.alt}
        width={856}
        height={483}
