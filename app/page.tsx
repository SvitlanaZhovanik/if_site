...
const Page: NextPage = () => {
  return (
    <section className="relative flex h-full flex-col text-white md:overflow-hidden portrait:overflow-hidden portrait:sm:min-h-[calc(100vh-100px)] portrait:notXL:min-h-[calc(100vh-88px)] landscape:md:min-h-[calc(100vh-88px)] landscape:smOnly:pb-[200px] landscape:mdOnly:pb-[400px]">
